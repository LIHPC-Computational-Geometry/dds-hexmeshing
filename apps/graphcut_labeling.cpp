...
int main(int argc, char *argv[]) {
    ...
    //parse results
    cxxopts::ParseResult_custom result(options,argc, argv, { path_list[GENOMESH] / "graphcut_labeling", path_list[GENOMESH] / "labeling_stats", path_list[FASTBNDPOLYCUBE] / "fastpolycube" });
    ...
    for(auto& input_folder : input_folders) {
        ...
        regenerate_Graphite_visu(path_list[WORKING_DATA_FOLDER],input_folder / output_folder_name,current_input_beginning,"the graphcut_labeling wrapper");
    }
