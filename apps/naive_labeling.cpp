...
int main(int argc, char *argv[]) {
    ...
    //parse results
    cxxopts::ParseResult_custom result(options,argc, argv, { path_list[GENOMESH] / "naive_labeling", path_list[GENOMESH] / "labeling_stats", path_list[FASTBNDPOLYCUBE] / "fastpolycube" });
    ...
    for(auto& input_folder : input_folders) {
        ...
        info.generated_by("naive_labeling");
        ...
        regenerate_Graphite_visu(path_list[WORKING_DATA_FOLDER],input_folder / output_folder_name,current_input_beginning,"the naive_labeling wrapper");
    }
